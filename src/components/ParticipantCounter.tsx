...
export const ParticipantCounter: React.FC<ParticipantCounterProps> = ({ participants }) => {
  ...
  return (
    <div className="flex flex-col gap-6 mb-8">
      <div className='w-full flex flex-wrap md:flex-nowrap gap-4 items-center justify-center'>
        <div className="bg-white w-full h-32 rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
      ...
      {jejumTypes.length > 0 && (
        <div className="w-full flex">
          <div className="bg-white w-full rounded-xl py-4 px-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-8">Distribuição por tipo de jejum</h3>
            <div className="flex flex-wrap-reverse w-full gap-8 md:gap-18 items-center justify-center">
              {jejumTypes.map(type => {
                ...
                return (
                  <div key={type} className="text-center">
                    <div className="w-22 h-22 mx-auto mb-2 bg-[#faba16]/5 border border-[#faba16] rounded-full flex items-center justify-center">
                      <span className="text-[#faba16] font-bold text-xl">{percentage.toFixed(1)}%</span>
                    </div>
                    <p className="text-base md:text-lg font-bold text-gray-900">{getJejumDescription(type)}</p>
